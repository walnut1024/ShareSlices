...
export function AuthLayout({ children, footer }: { children: ReactNode; footer?: ReactNode }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-muted/40 px-8 py-5">
      <Card className="min-h-[680px] w-[1088px] flex-row gap-0 overflow-hidden py-0">
        ...
        <aside className="flex w-[416px] flex-none flex-col justify-center bg-foreground px-10 py-14 text-background">
          <h2 className="m-0 text-2xl font-semibold leading-tight tracking-[-0.015em]">
            Give Every Idea An Audience
          </h2>
          <p className="mt-3.5 text-[13.5px] leading-[1.55] text-background/70">
