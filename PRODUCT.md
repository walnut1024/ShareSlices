...
state without a separately defined provider-event contract. The first release
does not consume Resend final-delivery webhooks. Adding delivered, bounced, or
complaint state is a separate product change that must verify signatures against
