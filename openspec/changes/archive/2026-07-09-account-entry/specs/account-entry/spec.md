# Account Entry — Delta Spec

Terminology follows `CONTEXT.md`. Change-local terms: "account entry screen" is the Web surface containing the register and log-in forms; "current-user check" is the supporting check used to verify signed-in state during acceptance.
