...
- [x] 3.4 Run `mise run api-test` while the canonical development stack is healthy, confirm the developer containers remain unchanged, then run `mise run check`.
